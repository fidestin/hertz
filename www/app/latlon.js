...
//function takes a userLocation and a radius and returns an array

function GetDerivedPoints(userLocation, distance)
{
	var circlePoints=new Array();
	//userLocation is a google maps LatLng  objectc
	var pU=new LatLon(userLocation.lat(),userLocation.lng());
	var	p0=pU.destinationPoint(0,distance); circlePoints[0]=p0;
	var	p1=pU.destinationPoint(90,distance); circlePoints[1]=p1;
	var	p2=pU.destinationPoint(180,distance); circlePoints[2]=p2;
	var	p3=pU.destinationPoint(270,distance); circlePoints[3]=p3;
